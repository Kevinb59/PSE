...
export const PREUVE_SITES: PreuveSite[] = [
  {
    ...
    imageSrc: "/media/preuves/navisphere.png",
    x: 21,
    y: 44,
  },
  {
    ...
    imageSrc: "/media/preuves/damien-verhee.png",
    x: 33,
    y: 27,
  },
  {
    ...
    imageSrc: "/media/preuves/smart-z.png",
    x: 47,
    y: 36,
  },
  {
    ...
    imageSrc: "/media/preuves/renmob.png",
    x: 56,
    y: 51,
  },
  {
    ...
    imageSrc: "/media/preuves/sophied.png",
    x: 71,
    y: 43,
  },
  {
    ...
    imageSrc: "/media/preuves/jinja-music.png",
    x: 84,
    y: 57,
  },
  {
    ...
    imageSrc: "/media/preuves/calypso-bay.png",
    x: 39,
    y: 63,
  },
  {
    ...
    imageSrc: "/media/preuves/pbdr.png",
    x: 64,
    y: 69,
  },
  {
    ...
    imageSrc: "/media/preuves/maoya-makeup.png",
    x: 27,
    y: 54,
  },
];
